    ...
    const handleCapturePhoto = async () => {
        try {
            ...
            if (photo.webPath) {
                ...
                const currentPhotoUris =
                    currentProject.projectDetails.photoUri || [];

                const updatedPhotoUris = [...currentPhotoUris, photo.webPath];
                const updatedProject = {
                    ...currentProject,
                    projectDetails: {
                        ...currentProject.projectDetails,
                        photoUri: updatedPhotoUris,
                    },
                };
